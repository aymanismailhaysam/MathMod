...
subtitle: "Задача о погоне - вариант 28"
author: "Исмаил Айман"
...
Через определенный промежуток времени туман рассеивается, и лодка обнаруживается на расстоянии 15 км от катера. 
